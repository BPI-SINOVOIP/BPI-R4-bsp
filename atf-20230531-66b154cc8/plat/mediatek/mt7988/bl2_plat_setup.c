...
static const struct plat_io_policy policies[] = {
	[FIP_IMAGE_ID] = { &boot_dev_handle, (uintptr_t)&mtk_boot_dev_fip_spec,
			   check_boot_dev },
	...
	[BL33_IMAGE_ID] = { &fip_dev_handle, (uintptr_t)&bl33_uuid_spec,
			    check_fip },
#ifdef MSDC_INDEX
	[GPT_IMAGE_ID] = { .dev_handle = &boot_dev_handle,
...
void bl2_platform_setup(void)
{
	...
	/* Initialize boot device for loading next stage loaders */
