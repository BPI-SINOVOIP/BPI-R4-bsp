...
BL31_SOURCES		+=	${MTK_PLAT_SOC}/mtk_tbbr.c			\
				...
				${MTK_PLAT}/common/mtk_sec_data.c		\
				${MTK_PLAT}/common/drivers/crypto/mtk_crypto.c
CPPFLAGS		+=	-DMTK_SECURE_DATA
ifeq ($(PREPARE_SECURE_DATA), 1)
CPPFLAGS		+=	-DMTK_PREPARE_SECURE_DATA
endif
PLAT_INCLUDES		+=	-I${MTK_PLAT}/common/drivers/crypto		\
